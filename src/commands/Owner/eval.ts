...
export class UserCommand extends Command {
  public override registerApplicationCommands(registry: ApplicationCommandRegistry) {
    const builder = new SlashCommandBuilder()
      ...
      .addStringOption((option) => option.setName('code').setDescription('This is the code you wish to evaluate').setRequired(true))
      .addBooleanOption((option) => option.setName('async').setDescription('Do you wish this code to be ran async?').setRequired(true));
  ...
  public override async chatInputRun(interaction: CommandInteraction) {
    ...
    const embed = new MessageEmbed()
      ...
      .addField(
        'Information:',
        `Type: ${type ?? 'There was no result'} \n Success: ${success ? emojis.CheckEmoji : emojis.CancelEmoji} \n Async: ${
          async ? emojis.CheckEmoji : emojis.CancelEmoji
